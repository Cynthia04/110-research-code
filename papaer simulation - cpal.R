#--------------- Use the normal estimate of table 3 to simulate data -----------#
est <- data.frame(a=c(rep(9.242,3),rep(9.446,3),rep(9.65,2)),
                  b=c(rep(2.212,3),rep(2.436,3),rep(2.66,2)),
                  sigma=c(rep(3.362,3),rep(4.246,3),rep(5.13,2)))
#--------------- Use the regression result to simulate data --------------------#
# est <- data.frame(a=c(rep(9.25,3),rep(9.45,3),rep(9.65,2)),
#                   b=c(rep(2.19,3),rep(2.43,3),rep(2.67,2)),
#                   sigma=c(rep(2.066,3),rep(2.758,3),rep(3.45,2)))
