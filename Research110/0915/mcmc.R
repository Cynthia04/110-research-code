...
tll <- function(theta,data){ # ll is -loglikeihood, so here is logL
...
for(i in 1:(m+N*k)){
  ...
  p1 <- exp(-(z1-0.0915)^2/(2*sigma^2))
  p0 <- exp(-(a00-0.0915)^2/(2*sigma^2))
  ...
  p1 <- exp(-(z2-0.000998)^2/(2*sigma^2))
  p0 <- exp(-(a10-0.000998)^2/(2*sigma^2))
  ...
  p1 <- exp(-(z3-0.000202)^2/(2*sigma^2))
  p0 <- exp(-(b00-0.000202)^2/(2*sigma^2))
  ...
  p1 <- exp(-(z4-0.000013)^2/(2*sigma^2))
  p0 <- exp(-(b10-0.000013)^2/(2*sigma^2))
  ...
  p1 <- exp(-(z5-0.00306)^2/(2*sigma^2))
  p0 <- exp(-(s00-0.00306)^2/(2*sigma^2))
  ...
  p1 <- exp(-(z6-0.00026)^2/(2*sigma^2))
  p0 <- exp(-(s10-0.00026)^2/(2*sigma^2))
